...
const Accion = () => {
        ...
        const fetchVideos = async () => {
            try {
                ...
                const actionVideos = data.filter(video => {
                    ...
                    const searchTerms = ['musica', 'musical'];
    ...
    const fondo1 = 'https://th.bing.com/th/id/OIP.fc9wTMt3yAlMzWOQFbbIQAHaEK?rs=1&pid=ImgDetMain'
    const fondo2 = 'https://th.bing.com/th/id/OIP.XCnBjJEEkJsbyKzEeA2W_gAAAA?rs=1&pid=ImgDetMain'
            ...
            <div className="container-pelis">
                <div className="referencia" style={{
                    ...
                    <div className="descrip">
                        <h1 style={{color: 'green'}}>Disfruta de los Mejores Musicales</h1>
