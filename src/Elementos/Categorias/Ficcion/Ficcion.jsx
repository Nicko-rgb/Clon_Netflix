...
const Ficcion = () => {
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                ...
                // Filtrar los videos que contienen "música" o "musical" en el campo genero
                const actionVideos = data.filter(video => {
                    const normalizedGenre = video.genero.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '');
                    const searchTerms = ['ciencia', 'ficcion'];
                    return searchTerms.some(term => normalizedGenre.includes(term));
                });
    ...
    const fondo1 = 'https://th.bing.com/th/id/R.f8ebc70bd677704d84f722290c869d88?rik=Le8hTfFXEWgnng&pid=ImgRaw&r=0'
    const fondo2 = 'https://th.bing.com/th/id/R.d55b7bf217c0aa879a00373a87436ea9?rik=R1mBmFLkb%2bWVtg&pid=ImgRaw&r=0'
    const fondo3 = 'https://th.bing.com/th/id/R.b5d99a61c9623564e4d93900852b5c7d?rik=mfWnhDSxeNrYqg&pid=ImgRaw&r=0'
    const fondo4 = 'https://www.cinepremiere.com.mx/wp-content/uploads/2021/06/peliculas-ciencia-ficcion-netflix-900x506.jpg'
