...
const Comedia = () => {
        ...
        const fetchVideos = async () => {
            try {
                ...
                const actionVideos = data.filter(video => {
                    ...
                    return normalizedGenre.includes('comedia');
                });
    ...
    const fondo1 = 'https://th.bing.com/th/id/OIP.B2sfB8lBJrMTkdYdOxIQdwHaEK?w=326&h=183&c=7&r=0&o=5&dpr=1.1&pid=1.7'
    const fondo2 = 'https://cdn.hobbyconsolas.com/sites/navi.axelspringer.es/public/media/image/2019/04/mejores-peliculas-risa-comedia-netflix-2019.jpg?tf=3840x'
    const fondo3 = 'https://th.bing.com/th/id/R.bb568fba96585498e2250a66048bca78?rik=ysDuHP%2ffYtBPqg&pid=ImgRaw&r=0'
    const fondo4 = 'https://ucwbling.chicagolandwritingcenters.org/wp-content/uploads/2016/03/Comedyscrawl.jpg'
    const fondos = [fondo3, fondo1, fondo2, fondo4]
            ...
            <div className="container-pelis">
                <div className="referencia" style={{
                    ...
                    <div className="descrip">
                        <h1 style={{color: 'orangered'}}>Las Mejoras Comedias del Cine</h1>
